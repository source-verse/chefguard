...
const Contact = () => {
  ...
  return (
    <section className="text-gray-600 body-font relative">
      ...
      <div className="container con px-10 pt-16 pb-16 lg:pt-24 lg:pb-24 mx-auto grid lg:grid-cols-2 max-w-lg lg:max-w-[1280px]">
        ...
        <div className="bg-white flex flex-col lg:ml-auto w-full md:mt-0">
